...
function InorganicReactions() {
  ...
  return (
    <div className="inorganic-reactions">
      <div className="page-header" style={styles.pageHeader}>
        <div>
          <h1 style={styles.pageTitle}>Inorganic Reactions</h1>
          <p style={styles.pageSubtitle}>
            Study inorganic chemical reactions with detailed animations showing ionic interactions
          </p>
        </div>
        <div style={styles.headerIcon}>
          <Atom size={48} color="#3b82f6" />
        </div>
      </div>
      ...
      <div className="reactions-layout" style={styles.reactionsLayout}>
        ...
        <div className="reaction-visualizer" style={styles.reactionVisualizer}>
          ...
          {selectedReaction ? (
            <ReactionVisualizer reaction={selectedReaction} type="inorganic" />
          ) : (
